...
import { useState } from 'react';
import { Container, Heading, Button, FormControl, FormLabel, Input, VStack } from '@chakra-ui/react';
import axios from 'axios';
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        if (uploadUrl) {
          ...
          console.error('Upload URL is undefined in the response:', response.data);
        }
      } else {
        console.error('Failed to get pre-signed URL:', response.statusText);
      }
